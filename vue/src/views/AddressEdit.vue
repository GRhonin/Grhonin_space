	...
	import Cookies from 'js-cookie';
        export default {
				...
				if(this.uName && this.phone && this.address && this.sTown){
				        if(Cookies.get('addressEdit') === 'add'){
                                                axios({
                                                        url: '/address/add',
                                                        method: 'post',
                                                        data: {
                ...
                created(){
                        ...
                        if(Cookies.get('addressEdit') === 'edit'){
                                axios({
                                                ...
                                                .then(result => {
                                                let { id, name, phone, phone2, province, city, town, county, address  } = result;
                                                this.id = id;
                                                this.uName = name;
                                                this.phone = phone;
                                                this.phone2 = phone2;
